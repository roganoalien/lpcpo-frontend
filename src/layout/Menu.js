		...
		<nav className="h-full menu-contianer flex flex-col">
			<div className="flex flex-col sticky top-0 pt-2">
				...
				>
					...
					<span className="hidden lg:block truncate text-lg font-bold">
						Inicio
					</span>
					<span className="notification-container ml-auto inline-block py-0.5 px-3 text-xs leading-4 rounded-full transition ease-in-out duration-150">
						15
					</span>
				</NavLink>
				{/* <NavLink
				...
				<div className="w-full flex items-center justify-center lg:justify-start px-0 lg:px-4 mt-4">
					...
					>
						...
						<span className="hidden lg:block">Crear Post</span>
					</button>
				</div>
